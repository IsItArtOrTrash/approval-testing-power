...
class OrderTest extends TestBase {
  ...
  @Test
  void approvalTest() throws JsonProcessingException {
    // given
    String orderId = "someOrderId";
    LocalDate deliveryDate = LocalDate.of(2024, 11, 22);
    UUID customerUuid = UUID.fromString("9e71d9c1-a066-41e0-a79e-061089110d85");
    ...
    // then
    JsonApprovals.verifyJson(outgoingOrderAsString, new Options(Scrubbers.scrubAll(new GuidScrubber(), DateScrubber.getScrubberFor("2024-06-10T15:04:24.426Z"))));
  }
